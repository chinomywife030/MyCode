// App.js (Expo Snack)
// Assets required:
// - ./assets/bag-empty.png
// - ./assets/bag-final.png
// - ./assets/airplane.png
...
const BAG_EMPTY = require("./assets/bag-empty.png");
const BAG_FINAL = require("./assets/bag-final.png");
const PLANE = require("./assets/airplane.png");
...
function sampleBezier(p0, p1, p2, samples = 44) {
  const tSamples = [];
  const xSamples = [];
  const ySamples = [];
...
export default function App() {
  ...
  const [bagRect, setBagRect] = useState(null);
...
const endY = headlineCy - 44 + END_OFFSET_Y;
  ...
  useEffect(() => {
    ...
    const T = (ms) => Math.max(1, Math.round(ms * TIME_SCALE));
